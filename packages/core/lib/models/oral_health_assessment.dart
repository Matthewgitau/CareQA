...
class OralHealthAssessment {
  final String? id;
  final String serviceUserId;
  final String assessorId;
  final DateTime assessmentDate;
  final Map<String, dynamic> responses;  // Will store all oral health data
  ...
  factory OralHealthAssessment.fromJson(Map<String, dynamic> json) => OralHealthAssessment(
    id: json['id'],
