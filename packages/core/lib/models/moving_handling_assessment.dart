...
class MovingHandlingAssessment {
  final String? id;
  final String serviceUserId;
  final String assessorId;
  final DateTime assessmentDate;
  final Map<String, dynamic> responses;  // Will store all moving & handling data
  final List<Map<String, dynamic>> actionPlan;
  final String? signature;
  final String status;
  final DateTime? createdAt;

  MovingHandlingAssessment({
    this.id,
  ...
  factory MovingHandlingAssessment.fromJson(Map<String, dynamic> json) => MovingHandlingAssessment(
    id: json['id'],
