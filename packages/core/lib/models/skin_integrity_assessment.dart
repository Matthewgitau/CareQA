...
class SkinIntegrityAssessment {
  final String? id;
  final String serviceUserId;
  final String assessorId;
  final DateTime assessmentDate;
  final Map<String, dynamic> responses;  // Will store all skin integrity data
  ...
  factory SkinIntegrityAssessment.fromJson(Map<String, dynamic> json) => SkinIntegrityAssessment(
    id: json['id'],
