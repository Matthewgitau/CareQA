...
class InfectionControlAudit {
  final String? id;
  final String serviceUserId;
  final String assessorId;
  final DateTime assessmentDate;
  final Map<String, dynamic> responses;  // Will store all audit data
  ...
  factory InfectionControlAudit.fromJson(Map<String, dynamic> json) => InfectionControlAudit(
    id: json['id'],
