...
class ActivityRiskAssessment {
  ...
  factory ActivityRiskAssessment.fromMap(Map<String, dynamic> map) {
    return ActivityRiskAssessment(
      ...
      reviewDate: (map['review_date'] as DateTime).toLocal(),
      status: map['status'],
      createdAt: (map['created_at'] as DateTime).toLocal(),
      updatedAt: (map['updated_at'] as DateTime).toLocal(),
      submittedAt: map['submitted_at'] != null ? (map['submitted_at'] as DateTime).toLocal() : null,
      submittedBy: map['submitted_by'],
      escalatedAt: map['escalated_at'] != null ? (map['escalated_at'] as DateTime).toLocal() : null,
      escalatedBy: map['escalated_by'],
      completedAt: map['completed_at'] != null ? (map['completed_at'] as DateTime).toLocal() : null,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'escalated_at': escalatedAt?.toUtc(),
