...
class IncontinenceAssessment {
  ...
  factory IncontinenceAssessment.fromMap(Map<String, dynamic> map) {
    return IncontinenceAssessment(
      ...
      assessmentDate: (map['assessment_date'] as DateTime).toLocal(),
      ...
      previousAssessmentDate: map['previous_assessment_date'] != null 
          ? (map['previous_assessment_date'] as DateTime).toLocal() 
          : null,
      ...
      reviewDate: map['review_date'] != null 
          ? (map['review_date'] as DateTime).toLocal() 
          : null,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'previous_assessment_date': previousAssessmentDate?.toUtc(),
