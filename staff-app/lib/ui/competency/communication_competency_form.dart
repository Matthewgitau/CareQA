...
/// Communication Competency Assessment Form
class CommunicationCompetencyForm extends StatefulWidget {
  const CommunicationCompetencyForm({super.key});
...
class _CommunicationCompetencyFormState extends State<CommunicationCompetencyForm> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'id': 'identify_communication_needs',
      'question': 'Can you identify different communication needs of service users?',
      'type': 'yes_no',
    },
    {
      'id': 'accessible_information_standard',
      'question': 'Do you understand the Accessible Information Standard requirements?',
      'type': 'yes_no',
    },
    {
      'id': 'communication_aids',
      'question': 'Can you use communication aids and techniques effectively?',
      'type': 'yes_no',
    },
    {
      'id': 'hearing_vision_loss',
      'question': 'Do you know how to communicate with service users who have hearing/vision loss?',
      'type': 'yes_no',
    },
    {
      'id': 'document_information',
      'question': 'Are you confident in documenting and sharing information appropriately?',
      'type': 'yes_no',
    },
  ];
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Communication competency submitted'), backgroundColor: Colors.green),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Communication Competency'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.chat, color: const Color(0xFF1565C0), size: 32),
                const SizedBox(width: 12),
                const Expanded(
                  child: Text('Communication Competency', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Text(
              'This assessment covers effective communication with service users and the Accessible Information Standard.',
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Overall, how confident do you feel with communication techniques?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
            const SizedBox(height: 12),
