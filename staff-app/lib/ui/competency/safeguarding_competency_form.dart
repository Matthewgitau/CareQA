...
/// Safeguarding Competency Assessment Form
class SafeguardingCompetencyForm extends StatefulWidget {
  const SafeguardingCompetencyForm({super.key});
...
class _SafeguardingCompetencyFormState extends State<SafeguardingCompetencyForm> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'id': 'identify_abuse_types',
      'question': 'Can you identify the types of abuse (physical, emotional, financial, neglect, sexual)?',
      'type': 'yes_no',
    },
    {
      'id': 'reporting_procedure',
      'question': 'Do you understand the safeguarding reporting procedure?',
      'type': 'yes_no',
    },
    {
      'id': 'recognise_signs',
      'question': 'Can you recognise signs of abuse and neglect in service users?',
      'type': 'yes_no',
    },
    {
      'id': 'respond_disclosure',
      'question': 'Do you know how to respond to a safeguarding disclosure?',
      'type': 'yes_no',
    },
    {
      'id': 'complete_referrals',
      'question': 'Are you confident in completing safeguarding referrals?',
      'type': 'yes_no',
    },
  ];
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Safeguarding competency submitted'), backgroundColor: Colors.green),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Safeguarding Competency'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.shield, color: const Color(0xFF1565C0), size: 32),
                const SizedBox(width: 12),
                const Expanded(
                  child: Text('Safeguarding Competency', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Text(
              'This assessment covers safeguarding adults and recognising signs of abuse.',
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Overall, how confident do you feel with safeguarding procedures?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
            const SizedBox(height: 12),
