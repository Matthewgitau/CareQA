...
/// Dignity & Respect Competency Assessment Form
class DignityRespectCompetencyForm extends StatefulWidget {
  const DignityRespectCompetencyForm({super.key});
...
class _DignityRespectCompetencyFormState extends State<DignityRespectCompetencyForm> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      ...
      'question': 'Do you understand the principles of person-centred care?',
      'type': 'yes_no',
    },
    {
      'id': 'privacy_dignity',
      'question': 'Can you demonstrate how to maintain service user privacy and dignity?',
      'type': 'yes_no',
    },
    {
      'id': 'support_choice',
      'question': 'Do you know how to support service user choice and independence?',
      'type': 'yes_no',
    },
    {
      'id': 'cultural_needs',
      'question': 'Can you identify cultural and religious needs of service users?',
      'type': 'yes_no',
    },
    {
      'id': 'challenge_disrespect',
      'question': 'Are you confident in challenging disrespectful behaviour from colleagues?',
      'type': 'yes_no',
    },
  ];
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      await _supabase.from('staff_competency_records').insert({
        ...
        'competency_type': 'dignity_respect',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Dignity & respect competency submitted'), backgroundColor: Colors.green),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dignity & Respect Competency'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.favorite, color: const Color(0xFF1565C0), size: 32),
                const SizedBox(width: 12),
                const Expanded(
                  child: Text('Dignity & Respect Competency', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Text(
              'This assessment covers person-centred care, dignity, and respect principles.',
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Overall, how confident do you feel promoting dignity and respect?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
            const SizedBox(height: 12),
