          ...
          : Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ...EpilepsyAssessment(seizureType: '', seizureFrequency: '', medicationCompliance: false, safeguardingConcerns: false, emergencyProtocol: '', rescueMedicationAdministered: false, status: 'draft', createdAt: DateTime.now(), updatedAt: DateTime.now()).getCommonTriggers().map((trigger) => 
                    _buildCheckboxField(
                      label: trigger,
                  ...
                  ...EpilepsyAssessment(seizureType: '', seizureFrequency: '', medicationCompliance: false, safeguardingConcerns: false, emergencyProtocol: '', rescueMedicationAdministered: false, status: 'draft', createdAt: DateTime.now(), updatedAt: DateTime.now()).getCommonInjuryRisks().map((risk) => 
                    _buildCheckboxField(
                      label: risk,
