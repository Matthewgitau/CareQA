...
class RepositioningAuditLog {
  ...
  factory RepositioningAuditLog.fromJson(Map<String, dynamic> json) => RepositioningAuditLog(
    id: json['id'],
...
class RepositioningChartSummary {
  final String id;
  final String serviceUserId;
  final DateTime chartDate;
  final int totalRepositions;
  final bool hasSkinConcerns;
  final String? createdBy;
  final DateTime? createdAt;
  final String? updatedBy;
  final DateTime? updatedAt;

  RepositioningChartSummary({
    required this.id,
    required this.serviceUserId,
    required this.chartDate,
    required this.totalRepositions,
    required this.hasSkinConcerns,
    this.createdBy,
    this.createdAt,
    this.updatedBy,
    this.updatedAt,
  ...
  factory RepositioningChartSummary.fromJson(Map<String, dynamic> json) => RepositioningChartSummary(
    id: json['id'],
    serviceUserId: json['service_user_id'],
    chartDate: DateTime.parse(json['chart_date']),
    totalRepositions: json['total_repositions'] ?? 0,
    hasSkinConcerns: json['has_skin_concerns'] ?? false,
    createdBy: json['created_by'],
    createdAt: json['created_at'] != null ? DateTime.parse(json['created_at']) : null,
    updatedBy: json['updated_by'],
    updatedAt: json['updated_at'] != null ? DateTime.parse(json['updated_at']) : null,
